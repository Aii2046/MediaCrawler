...
from .routers import crawler_router, data_router, note_content_router, websocket_router
...
app.include_router(note_content_router, prefix="/api")
...
async def serve_note_content_page():
    """Return note content fetching page"""
    page_path = os.path.join(WEBUI_DIR, "note_content.html")
    if os.path.exists(page_path):
        return FileResponse(page_path)
    return {"error": "Note content page not found"}
